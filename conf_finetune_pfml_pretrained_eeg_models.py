...
The configuration file for finetune_pfml_pretrained_eeg_models.py.
...
pretrained_model_conf_file = 'conf_pfml_pretrain_eeg'
...
result_dir = f'pfml_finetuning_results_eeg_{finetuning_experiment_number}'
...
name_of_log_textfile = f'pfml_finetuning_eeg_trainlog_{finetuning_experiment_number}.txt'
...
dataset_name = 'sleep_edf_expanded_dataset_pfml_finetuning'
...
# Select if we want to split our training and validation data so that test subject-specific data is included
# in both sets.
mix_train_val_subjects = False

# The hyperparameters for our data loaders
params_train_dataset = {'preprocessed_data_dir': './preprocessed_sleep_edf_exp_files_framed',
                        'train_val_ratio': train_val_ratio,
                        'mix_train_val_subjects': mix_train_val_subjects}

params_validation_dataset = {'preprocessed_data_dir': './preprocessed_sleep_edf_exp_files_framed',
                             'train_val_ratio': train_val_ratio,
                             'mix_train_val_subjects': mix_train_val_subjects}

params_test_dataset = {'preprocessed_data_dir': './preprocessed_sleep_edf_exp_files_framed',
                       'train_val_ratio': train_val_ratio,
                       'mix_train_val_subjects': mix_train_val_subjects}
