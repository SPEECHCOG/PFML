...
The configuration file for pfml_pretrain_eeg.py.
...
name_of_log_textfile = f'trainlogs_pfml_pretraining/pfml_trainlog_eeg_{experiment_num}.txt'
...
encoder_best_model_name = f'pfml_pretrained_models/pfml_Encoder_eeg_best_model_{experiment_num}.pt'
transformer_best_model_name = f'pfml_pretrained_models/pfml_Transformer_eeg_best_model_{experiment_num}.pt'
decoder_best_model_name = f'pfml_pretrained_models/pfml_Decoder_eeg_best_model_{experiment_num}.pt'

# The base name of the files containing the output of the feature extraction process
feature_extraction_model_output_savefile_basename = f'feature_extraction_output/eeg_pfml_feats_{experiment_num}'
...
encoder_model_params = {'conv_1_in_dim': num_input_channels,
                        'conv_1_out_dim': 128,
                        ...
                        'conv_3_in_dim': 128,
                        'conv_3_out_dim': encoder_num_output_channels,
                        'conv_3_kernel_size': (1,4),
                        'conv_3_stride': (1,3),
                        'conv_3_padding': (0,1),
                        'num_norm_features_3': encoder_num_output_channels,
...
prob_frame_is_start_of_embedding_mask = 0.1
...
abs_pos_encoding_max_sequence_length = 14
...
rel_pos_encoding_conv_kernel_size = 9 # The CNN kernel size of the positional encodings
rel_pos_encoding_conv_stride = 1 # The CNN stride of the positional encodings
rel_pos_encoding_conv_padding = 4 # The CNN padding of the positional encodings
...
dataset_name = 'sleep_edf_expanded_dataset_pfml'
...
params_validation_dataset = {'data_dir': './sleep_edf_78',
                             ...
                             'window_len_seconds': window_len_seconds,
                             'hop_len_seconds': hop_len_seconds}
params_feature_extraction_dataset = {'data_dir': './sleep_edf_78',
                                     'preprocess_data': False,
                                     'preprocessed_data_dir': './preprocessed_sleep_edf_exp_files_framed',
                                     'precompute_functionals': False,
                                     'functionals_save_dir': './precomputed_sleep_edf_exp_functionals',
